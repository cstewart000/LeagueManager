...
public class Player implements Comparable<Player>, Serializable {
  ...
  public String toString() {
    return firstName + " "+lastName + " " + heightInInches+ " (in)" + previousExperience;
  }
  ...
  public int compareTo(Player other) {
    ...
    // If the last name is equivalent, compare first name
    if(comparison==0){
      comparison = this.getFirstName().compareTo(other.getFirstName());
    }
